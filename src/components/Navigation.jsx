                ...
                <div className="d-flex align-items-center w-100">
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        ...
                        <Nav className="ms-auto gap-3 align-items-center">
                            ...
                            <Nav.Link href="https://github.com/donovan-crowley" target="_blank" className="text-accent transition-colors" style={{ transition: 'color 0.2s ease-in-out' }} onMouseOver={(e) => e.currentTarget.style.color = '#ffffff'} onMouseOut={(e) => e.currentTarget.style.color = 'var(--accent)'}>
