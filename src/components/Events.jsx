        ...
        <div id="events" className="py-5 bg-light text-black">
            <Container className="py-4">
                ...
                <Row className="g-4 align-items-stretch">
                    ...
                    {/* RIGHT COLUMN: Upcoming Event Card */}
                    <Col md={6} className="d-flex">
                        <div className="bg-white p-5 rounded-4 shadow-sm border d-flex flex-column justify-content-between w-100 position-relative overflow-hidden">
                            ...
                            <div className="mb-3">
                                ...
                                <h3 className="fw-bold mt-3 mb-2" style={{ color: '#000000', fontSize: '1.5rem' }}>
                                    Community Health Screening & Blood Panel Fair
                                </h3>
                            </div>

                            <div className="text-secondary mb-4">
                                <p className="mb-2"><strong>Date:</strong> August</p>
                                <p className="mb-2"><strong>Time:</strong> TBD </p>
                                <p className="mb-3"><strong>Location:</strong> TBD</p>
                                <p className="text-muted small mb-0">
                                    Join us for free comprehensive metabolic panels, lipid screenings, and CBC blood tests. Walk-ins are welcome, and no insurance is required.
                                </p>
                            </div>

                            <div>
                                <Button 
                                    href="#donate" // Or link to a sign-up modal / external form
                                    ...
                                    onClick={(e) => {
                                        ...
                                        alert("Event registration clicked!");
